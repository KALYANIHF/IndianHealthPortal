...
<body>
    <ul id="slides">
        <li class="slide showing">Weolcome KRH</li>
        <li class="slide">Weolcome KRH</li>
        <li class="slide">Weolcome KRH</li>
        <li class="slide">Weolcome KRH</li>
        <li class="slide">Weolcome KRH</li>
    </ul>
    ...
    <section class="flexbox">
        <div class="one1">
            <div class="docname">
                ...
                <a href="appointment.php?type=Q"><button class="btn btn-primary">appoinment</button></a>
            </div>
            <div class="docname">
                <h3>
                    Name:&nbsp; DR. G. D. MONDAL
                ...
                <a href="appointment.php?type=R"><button class="btn btn-primary">appoinment</button></a>
            </div>
            <div class="docname">
                <h3>
                    Name:&nbsp; DR. Ar. SEN
                ...
                <h5>Degree: &nbsp;MBBS</h5>
                <a href="appointment.php?type=S"><button class="btn btn-primary">appoinment</button></a>
            </div>
            <div class="docname">
                <h3>
                    Name:&nbsp; DR. (MRS.) S. DAS
                ...
                <a href="appointment.php?type=T"><button class="btn btn-primary">appoinment</button></a>
            </div>
        </div>
        <div class="one2">
            <div class="docname">
                ...
                <h5>Degree: &nbsp;MBBS,BDS</h5>
                <a href="appointment.php?type=U"><button class="btn btn-primary">appoinment</button></a>
            </div>
            <div class="docname">
                <h3>
                    Name:&nbsp;DR. R. K. ROY
                ...
                <h5>Degree: &nbsp;MBBS</h5>
                <a href="appointment.php?type=V"><button class="btn btn-primary">appoinment</button></a>
            </div>
            <div class="docname">
                <h3>
                    Name:&nbsp; DR. P. K. BASU
                ...
                <a href="appointment.php?type=W"><button class="btn btn-primary">appoinment</button></a>
            </div>
            <div class="docname">
                <h3>
                ...
                <h5>Specialist :&nbsp; HE</h5>
                <h5>Degree: &nbsp;MBBS</h5>
                <a href="appointment.php?type=X"><button class="btn btn-primary">appoinment</button></a>
            </div>
        </div>
    </section>
    <section class="bfoo">
